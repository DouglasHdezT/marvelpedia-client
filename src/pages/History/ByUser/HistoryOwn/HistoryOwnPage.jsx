...
import { findHistoryOwn } from "../../../../services/CatalogsService";
...
const HistoryOwnPage = () => {
  ...
  const onFinish = async () => {
    ...
    const _items = await findHistoryOwn();
    if(_items === null) {
  ...
  return (
    <PrivateRoute>
      <section className="w-full p-6 flex flex-col gap-4">
        <h1 className="text-center font-montserrat font-bold"> Search OWN History </h1>
      </section>
